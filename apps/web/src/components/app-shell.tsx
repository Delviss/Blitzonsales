...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/kennzahlen', label: 'Kennzahlen', icon: Gauge, roles: PHASE1_READ },
      { to: '/drilldown', label: 'Drilldown', icon: Search, roles: PHASE1_READ },
      ...
      { to: '/akzeptanz', label: 'Akzeptanz', icon: ClipboardCheck, roles: PHASE1_READ },
