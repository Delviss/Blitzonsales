 ...
 * the category.
 */
export declare enum StatusKategorie {
    Aktiv = "aktiv",
    Pruefung = "pruefung",
    Abgelehnt = "abgelehnt",
    Clawback = "clawback"
 ...
 */
export declare const STATUS_MASTER_DEFAULTS: StatusMasterEntry[];
...
export declare const PHASE1_READ_ROLLEN: Rolle[];
/**
 ...
 */
export declare const PHASE1_OPERATIONS_ROLLEN: Rolle[];
/**
 ...
 */
export declare const RESERVIERTE_PORTAL_ROLLEN: Rolle[];
